...
export class Navbar extends Component {
  ...
  render() {
    ...
    return (
        <>
            <div>
                 <nav className="navbar navbar-expand-lg " style={{ backgroundColor: '#133E87',color:'#FFFFFF' }}>
                    <div className="container-fluid">
                        ...
                        <div className="navbar-nav">
                            ...
                            <Link className="nav-link"  to="/entertainemnt" style={{color:'#FFFFFF'}}>Entertainemnt</Link>
                   ...
                   <button type="button" id='mine' class="btn btn-danger">Subscribe</button>
                   <button type="button" class=" btnOne "><Link className='nav-link' to="/login">Login</Link></button>
